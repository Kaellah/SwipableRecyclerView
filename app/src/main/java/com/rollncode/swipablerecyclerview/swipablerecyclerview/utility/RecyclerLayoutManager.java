package com.rollncode.swipablerecyclerview.swipablerecyclerview.utility;
...
//        }
    ...
    private void measureChildWithDecorationsAndMargin(View child, int widthSpec, int heightSpec) {
        ...
        Log.w("heightSpec", "before heightSpec = " + heightSpec);
        heightSpec = updateSpecWithExtra(heightSpec, lp.topMargin + decorRect.top, lp.bottomMargin + decorRect.bottom);
//        heightSpec = updateSpecWithExtra(heightSpec, 0, 0);
        Log.w("heightSpec", "after heightSpec = " + heightSpec);
...
//        return false;//orientation == Orientation.VERTICAL;
        return orientation == Orientation.VERTICAL;
    }

//    @Override
//    public boolean canScrollHorizontally() {
//        return false;//orientation == Orientation.HORIZONTAL;
//    }
//
//    @Override
